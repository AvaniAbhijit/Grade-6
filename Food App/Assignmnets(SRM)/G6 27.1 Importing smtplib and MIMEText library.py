...
import smtplib # This module in Python provides a way to send email messages via Simple Mail Transfer Protocol (SMTP).
from email.mime.text import MIMEText #MIMEText is a class within this module that allows you to create email messages containing text content.
...
def view_cart():
    ...
    if not cart:
        ...
        # Add checkout button
        checkout_button = tk.Button(cart_window, text="Checkout", command=process_checkout, bg="black", fg="white")
