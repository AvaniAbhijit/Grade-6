#Task 1 - Run the code and delete the item and then open the cart again. The item is not removed.
#Task 2 - Uncomment the code to understand the remove item function to Remove items from the treeview.
