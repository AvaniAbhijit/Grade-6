#Task - Write code to display tree view on the line 132.
import tkinter as tk
from PIL import ImageTk, Image
from tkinter import messagebox
from tkinter import ttk #import module
...
cart_window = None #global variable to hold the cart window
...
def view_cart():
    ...
    # Add cart items to the Treeview
    for i, item in enumerate(cart, start=1):
        tree.insert('', 'end', text=i, values=(item['name'], item['quantity'], item['price'], item['quantity'] * item['price']))

    # Pack the Treeview to display
...
view_cart_button = tk.Button(root, text="View Cart", command=view_cart, bg="black", fg="white") #adding a button to view cart
