#Task 1 : Modify the code to bind a right-click (<Button-3>)
#event on the images to show the details popup as well?
#Task 2: Add a hover effect to highlight an image
